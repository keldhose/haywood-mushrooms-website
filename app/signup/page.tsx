    ...
    <main className="flex min-h-[calc(100vh-78px)] items-center justify-center bg-cream px-6 py-16">
      <div className="w-full max-w-[440px] rounded-[4px] border border-line bg-paper p-10">
        <div className="font-mono text-[11px] uppercase tracking-[0.16em] text-muted">
          Haywood Mushrooms / Sign up
        </div>
        <h1 className="mt-4 font-serif text-[32px] text-ink">Create your account</h1>
        <p className="mt-2.5 text-[15px] text-muted">
          Save your details and track orders as you grow with us.
        </p>
        ...
        <p className="mt-6 text-center text-[14px] text-muted">
          ...
          <Link href={`/login${next !== "/account" ? `?next=${encodeURIComponent(next)}` : ""}`} className="text-forest hover:text-brass">
            Log in
          </Link>
        </p>
      </div>
